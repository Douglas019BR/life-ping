...
export const UpdateMultipleEmergencyContactsSchema = z.object({
  contacts: z
    .array(
      z.object({
        id: z.string().uuid(),
...
export type UpdateMultipleEmergencyContactsDTO = z.infer<
  typeof UpdateMultipleEmergencyContactsSchema
>;
